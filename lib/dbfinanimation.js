...
const dbFinAnimation = new Lang.Class({
    ...
    _timeoutFinalize: function() {
        if (!this._actors || !this._callbacks) {
            log('Warning: dbFinAnimation._timeoutFinalize: ' + (!this._actors ? 'this._actors === null' : 'this._callbacks === null'));
            return;
        }
        this._lock++;
        this._timeoutCancel();
    ...
    timeout: function(actor, state) {
        if (!this._actors || !this._callbacks) {
            log('Warning: dbFinAnimation.timeout: ' + (!this._actors ? 'this._actors === null' : 'this._callbacks === null'));
            return;
        }
        this._lock++;
    ...
    timeoutRemove: function(actor, property) {
        if (!this._actors || !this._callbacks) {
            log('Warning: dbFinAnimation.timeoutRemove: ' + (!this._actors ? 'this._actors === null' : 'this._callbacks === null'));
            return;
        }
        this._lock++;
